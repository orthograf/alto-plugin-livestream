...
{if count($aStreamEvents)}
	{foreach $aStreamEvents as $oStreamEvent}
		...
		<li class="stream-item stream-item-type-{$sEventType} user-block" style="display: block; clear: both;">
            <div class="row bob mal0 marr0 pab6 mab6">
                <div class="pull-left">
                    <a href="{$oUser->getProfileUrl()}"><img src="{$oUser->getAvatarUrl('small')}" alt="{$oUser->getDisplayName()}" class="user-avatar"/></a>
                </div>
                <div style="">
                    <div class="stream-body livestream-body">
