...
<script>
    ...
    <div class="panel-body">
        <div class="panel-header">
            ...
            <a class=""
               ...
               title="{$aLang.widget_stream_comments_all}">{$aLang.plugin.livestream.widget_livestream}</a>
            <a href="#"
               onclick="
    ...
    {if $aWidgetParams.hide_footer == false}
        <div class="panel-footer">
            ...
            <a class="link link-dual link-lead link-clear pull-right" href="{router page='comments'}"><i class="fa fa-comment"></i>{$aLang.plugin.livestream.widget_livestream_comments_all}</a>
        </div>
    {/if}
</div>